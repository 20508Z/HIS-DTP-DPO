...
# Example launch script for HIS-Guard training on Qwen2.5-VL-3B.
# Adjust paths and GPU count for the local review environment.

MODEL_PATH=${MODEL_PATH:-models/Qwen2.5-VL-3B}
DATA_PATH=${DATA_PATH:-data/preference_data.json}
OUTPUT_DIR=${OUTPUT_DIR:-checkpoints/his_guard_qwen3b}
NUM_GPUS=${NUM_GPUS:-4}
